// Demo data seed — análisis de fluido (aceite de motor) para tenant Mercurio,
// buque DONCHI (Don Chicueto). 10 muestras en los 4 motores: serie deteriorándose
// en el Auxiliar N°1 (NORMAL→PRECAUCIÓN→CRÍTICO) y tendencia de precaución en el N°2.
// Etiquetas en español. Idempotente por marker.
//
// Uso (VPS, cwd /app, DATABASE_URL exportada):
//   node_modules/.bin/tsx tmp-merc.ts          → aplica
//   DRY=1 node_modules/.bin/tsx tmp-merc.ts     → previsualiza
//   REVERT=1 node_modules/.bin/tsx tmp-merc.ts  → borra (hard) lo creado por este seed
...
const TENANT_ID = "cmoj8spsj0013dxl4mlgyvu70"; // Mercurio
const VESSEL = "DONCHI";
...
const A = {
  AUX1: "cmoz9gbxl02no6rl4gtkfdb13", // Motor Auxiliar N°1 (Babor)
  AUX2: "cmoz9gbxm02np6rl42h8c1aiy", // Motor Auxiliar N°2 (Estribor)
  AUX3: "cmoz9gbxo02nq6rl4qpv6h1j3", // Motor Auxiliar N°3 (Puerto)
  LAN1: "cmoz9gbxz02o06rl4o1cvotud", // Motor Lancha de Trabajo 1
};
...
const SAMPLES: S[] = [
  // Motor Auxiliar N°1 (Babor) — serie deteriorándose
  { asset: A.AUX1, verdict: "NORMAL",   dayAgo: 90, rh: 12000 },
  { asset: A.AUX1, verdict: "CAUTION",  dayAgo: 45, rh: 13100 },
  { asset: A.AUX1, verdict: "CRITICAL", dayAgo: 10, rh: 14050 },
  // Motor Auxiliar N°2 (Estribor) — tendencia de precaución
  { asset: A.AUX2, verdict: "NORMAL",   dayAgo: 80, rh: 11800 },
  { asset: A.AUX2, verdict: "CAUTION",  dayAgo: 40, rh: 12600 },
  { asset: A.AUX2, verdict: "CAUTION",  dayAgo: 8,  rh: 13200 },
  // Motor Auxiliar N°3 (Puerto) — normal
  { asset: A.AUX3, verdict: "NORMAL",   dayAgo: 60, rh: 9800 },
  { asset: A.AUX3, verdict: "NORMAL",   dayAgo: 12, rh: 10300 },
  // Motor Lancha de Trabajo 1 — normal
  { asset: A.LAN1, verdict: "NORMAL",   dayAgo: 50, rh: 3400 },
  { asset: A.LAN1, verdict: "NORMAL",   dayAgo: 14, rh: 3650 },
];
