...
/**
 * Extract the client IP. Trusts X-Forwarded-For / X-Real-IP because the app
 * runs behind Nginx; in a deployment without a reverse proxy these headers
 * would be untrusted and this function should be hardened.
 */
